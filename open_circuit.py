...
distorted_image = cv2.imread('rotation/Open_circuit_rotation/01_open_circuit_06.jpg')
...
#BFMatcher kullanarak en yakın eşleşmeleri bulma
...
for contour in contours:
    ...
    if 20 < area < 80:  # Alan aralığını daralttık
...
#XML dosyası
xml_file_path = 'Annotations/Open_circuit/01_open_circuit_06.xml'
